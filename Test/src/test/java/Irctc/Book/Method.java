...
public class Method {
	...
	public void Data() throws IOException {
		...
		FileInputStream fin = new FileInputStream(
				"C:\\Users\\admin\\workspace\\Test\\src\\test\\java\\Irctc\\Book\\data.properties");
		p.load(fin);
	}

	public void Screenshot() throws IOException {
		File scrFile = ((TakesScreenshot) test).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(scrFile, new File("C:\\Users\\admin\\workspace\\Test\\Screenshots\\screenshot.png"));
	}

	public void Time(long s) {
		test.manage().timeouts().implicitlyWait(s, TimeUnit.SECONDS);
	}
